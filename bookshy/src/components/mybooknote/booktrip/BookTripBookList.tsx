...
const BookTripBookList = ({ books, onClick }: Props) => (
  <div className="flex flex-col gap-4">
    {books.map((book) => (
      <div key={book.tripId} className="flex items-center gap-3 p-3 bg-white rounded-md shadow">
        <img
        ...
        <div className="flex-1">
          ...
          <div className="mt-1 text-xs font-semibold text-green-600">여정 작성됨</div>
        </div>
        <button
