...
const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    <div className="bg-light-bg rounded-xl p-4 mb-5 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
      <div className="flex items-start">
        ...
        {/* 책 이미지 */}
        <img src="/icons/bookstats.svg" alt="책 이미지" className="w-14 h-14 ml-4 flex-shrink-0" />
      </div>
    </div>
  );
};
